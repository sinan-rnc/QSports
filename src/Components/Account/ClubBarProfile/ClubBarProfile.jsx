                ...
                <form className="form-table">
                    <div className="same-line">
                        <div className="form-group">
                            <label className="form-label" htmlFor="clubBarName">Club/Bar Name</label>
                            <input type="text" className="form-control" id="clubBarName" placeholder="Enter the Club/Bar Name"/>
                        </div>
                        <div className="form-group">
                            <label className="form-label" htmlFor="clubBarNumber">Club/Bar ID</label>
                            <input type="text" className="form-control" id="clubBarNumber" placeholder="Enter the Club/Bar ID"/>
                        </div>
                    </div>
                    <div className="same-line">
                        <div className="form-group">
                            <label className="form-label" htmlFor="clubBarNumber">Club/Bar Slogan</label>
                            <input type="text" className="form-control" id="clubBarNumber" placeholder="Enter the Club/Bar Slogan"/>
                        </div>
                        <div className="form-group">
                            <label className="form-label" htmlFor="clubBarNumber">Club/Bar Images</label>
                    ...
                    <div className="form-group">
                        <label className="form-label" htmlFor="phoneNumber">Website Link</label>
                    ...
                    <div className="same-line">
                        ...
                        <div className="form-group">
                            <label className="form-label" htmlFor="location">Geo Location</label>
                            <input type="text" className="form-control" id="location" placeholder="Enter the Geo Location"/>
                        </div>
                    </div>
                    <div className="form-group">
                        <label className="form-label" htmlFor="city"><h1>Services</h1></label>
                    ...
                    <div className="form-group">
                        <label className="form-label" htmlFor="city"><h1>Food and Drinks Service</h1></label>
                        {selectedFoodServices.map((service) => renderFoodInputField(service))}
                        <div className="same-line">
                            <label className="form-label" htmlFor="city">Add a Service</label>
                            <select 
                                className="form-control"
                                id="services"
                    ...
                    <div className="form-group">
                        ...
                        <div className="same-line-openclose">
                            <div className="same-line">
                                <label className="form-label" htmlFor="city">Happy hour rate</label>
                                <input type="text" className="form-control" id="city" placeholder="Happy hour rate"/>
                            </div>
                            <div className="same-line">
                                <label className="form-label" htmlFor="city">Regular hour rate</label>
                                <input type="text" className="form-control" id="city" placeholder="Regular hour rate"/>
                            </div>
                        </div>
                    </div>
                    <div className="form-group">
                        <label className="form-label" htmlFor="location">Why "Your Club name here"</label>
                    ...
                    <div className="form-group">
                        <label className="form-label" htmlFor="location">History of the Club</label>
